...
lblInfo=Label(Tops,font=('helvetica',50,'bold'),text="OSTL RESTAURANT ",fg="Black",bd=10,anchor='w')
...
def Ref():
    ...
    CostofFries =CoFries * 95
    CostofDrinks=CoD * 30
    CostofNoodles = CoNoodles* 75
    CostofSoup = CoSoup * 90
    CostBurger = CoBurger* 150
    CostSandwich=CoSandwich * 65
...
lblMenu=Label(f1,font=('arial',16,'bold'),text="French Fries",bd=10,anchor='w')
lblMenu.grid(row=0,column=5)
lblFcost=Label(f1,font=('arial',16,'bold'),text="95",bd=10,anchor='w')
lblFcost.grid(row=0,column=6)

lblMenu=Label(f1,font=('arial',16,'bold'),text="Cold Drinks",bd=10,anchor='w')
lblMenu.grid(row=1,column=5)
lblFcost=Label(f1,font=('arial',16,'bold'),text="30",bd=10,anchor='w')
lblFcost.grid(row=1,column=6)

lblMenu=Label(f1,font=('arial',16,'bold'),text="Noodles",bd=10,anchor='w')
lblMenu.grid(row=2,column=5)
lblFcost=Label(f1,font=('arial',16,'bold'),text="75",bd=10,anchor='w')
lblFcost.grid(row=2,column=6)

lblMenu=Label(f1,font=('arial',16,'bold'),text="Soup",bd=10,anchor='w')
lblMenu.grid(row=3,column=5)
lblFcost=Label(f1,font=('arial',16,'bold'),text="90",bd=10,anchor='w')
lblFcost.grid(row=3,column=6)

lblMenu=Label(f1,font=('arial',16,'bold'),text="Burger",bd=10,anchor='w')
lblMenu.grid(row=4,column=5)
lblFcost=Label(f1,font=('arial',16,'bold'),text="150",bd=10,anchor='w')
lblFcost.grid(row=4,column=6)

lblMenu=Label(f1,font=('arial',16,'bold'),text="Sandwich",bd=10,anchor='w')
lblMenu.grid(row=5,column=5)
lblFcost=Label(f1,font=('arial',16,'bold'),text="65",bd=10,anchor='w')
lblFcost.grid(row=5,column=6)
